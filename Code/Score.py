...
from Code.Const import COLOR_YELLOW, COLOR_WHITE, SCORE_POS, MENU_OPTION, COLOR_CYAN
...
class Score:
    ...
    def save(self, game_mode: str, player_score: list[int]):
        ...
        while True:
            ...
            self.score_text(18, text, COLOR_CYAN, SCORE_POS['EnterName'])
            ...
            for event in pygame.event.get():
                if event.type == pygame.QUIT:
                    ...
                    if event.key == K_RETURN and len(name) == 4:
                        ...
                        if len(name) < 4:
                            name += event.unicode
            self.score_text(20, name, COLOR_CYAN, SCORE_POS['Name'])
            pygame.display.flip()
            pass
